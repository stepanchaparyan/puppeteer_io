module.exports = {
    BOT_SECTION: {
        SELECTORS: {
            ...
            CREATE_BOT: 'body > app-root > div > iox-page-container > div > iox-bots > div > div:nth-child(22) > button',
            ...
            //QUESTION_TYPE_FREETEXT: 'body > modal-container > div > div > div.modal-body > form > div.form-group.ng-star-inserted > div > select > option:nth-child(2)',
